create table tb_movie (count integer, score float(53), id bigint generated by default as identity, image varchar(255), title varchar(255), primary key (id));
create table tb_score (score_value float(53), movie_id bigint not null, user_id bigint not null, primary key (movie_id, user_id));
create table tb_user (id bigint generated by default as identity, email varchar(255), primary key (id));
